<%@ Page Title="" Language="VB" MasterPageFile="~/Hospital.master" AutoEventWireup="false" CodeFile="HOS_BED.aspx.vb" Inherits="HOS_BED" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <link rel="Stylesheet" href="styleSheet3.css" />
    <center>
    <div class="form" style="margin-left:100px;margin-top:100px;">
    <h2>UPDATE BED_INFO</h2>
    ...
    <asp:TextBox ID="txtTbed" runat="server" BackColor="Black" 
        BorderColor="#FF6600" ForeColor="White" Width="210px" placeholder="Enter Total Bed"></asp:TextBox>
    <asp:TextBox ID="txtEbed" runat="server" BackColor="Black" 
        BorderColor="#FF6600" ForeColor="White" Width="210px" placeholder="Enter Empty Bed"></asp:TextBox>
    ...
    <table style="width: 100%; border: 1px solid #FFFFFF;margin-left:50px; margin-top:100px; height: 527px;">
        ...
        <asp:Image ID="Image1" runat="server" Height="503px" magin-left="60px"
                    ImageUrl="~/Image/Hospital bed.png" Width="690px" />
